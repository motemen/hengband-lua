/*
** Lua binding: monster
** Generated automatically by tolua 5.0a on Sun Apr 27 06:44:49 2008.
*/
...
#ifndef TOLUA_RELEASE
 if (tolua_index<0 || tolua_index>=4/*MONSTER_BLOW_MAX*/)
...
static int tolua_set_monster_type_energy(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->energy_need = ((byte)  tolua_tonumber(tolua_S,2,0));
 return 0;
}

// TODO use self->mtimed[MTIMED_STUNNED], etc
#if 0
...
static int tolua_get_monster_mon_list(lua_State* tolua_S)
{
 ...
 tolua_index = (int)tolua_tonumber(tolua_S,2,0)-1;
#ifndef TOLUA_RELEASE
 if (tolua_index<0 || tolua_index>=max_m_idx)
 tolua_error(tolua_S,"array indexing out of range.",NULL);
#endif
 tolua_pushusertype(tolua_S,(void*)&m_list[tolua_index],"monster_type");
 return 1;
}
...
static int tolua_set_monster_mon_list(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"array indexing out of range.",NULL);
#endif
  m_list[tolua_index] = *((monster_type*)  tolua_tousertype(tolua_S,3,0));
 return 0;
}
...
static int tolua_monster_get_mon_num_prep00(lua_State* tolua_S)
{
 ...
 {
 {
  errr tolua_ret = (errr)  get_mon_num_prep(get_mon_num_hook, get_mon_num2_hook); // TODO 引数を検討
 tolua_pushnumber(tolua_S,(long)tolua_ret);
 }
 }
 return 1;
...
static int tolua_monster_summon_specific00(lua_State* tolua_S)
{
 ...
 {
  bool tolua_ret = (bool)  summon_specific(y1,x1,lev,type); // TODO needs who
 tolua_pushboolean(tolua_S,(bool)tolua_ret);
 }
 }
 return 1;
...
static int tolua_monster_monster_death00(lua_State* tolua_S)
{
...
#endif
 {
  int m_idx = ((int)  tolua_tonumber(tolua_S,1,0));
 {
  monster_death(m_idx); // TODO needs drop_item
 }
 }
 return 0;
#ifndef TOLUA_RELEASE
