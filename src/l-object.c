/*
** Lua binding: object
** Generated automatically by tolua 5.0a on Sun Apr 27 06:44:51 2008.
*/
...
static int tolua_set_object_type_note(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->inscription = ((u16b)  tolua_tonumber(tolua_S,2,0));
 return 0;
}
...
static int tolua_get_object_k_info(lua_State* tolua_S)
{
 ...
 tolua_index = (int)tolua_tonumber(tolua_S,2,0)-1;
#ifndef TOLUA_RELEASE
 if (tolua_index<0 || tolua_index>=max_k_idx)
 tolua_error(tolua_S,"array indexing out of range.",NULL);
#endif
...
static int tolua_get_object_a_info(lua_State* tolua_S)
{
 ...
 tolua_index = (int)tolua_tonumber(tolua_S,2,0)-1;
#ifndef TOLUA_RELEASE
 if (tolua_index<0 || tolua_index>=max_a_idx)
 tolua_error(tolua_S,"array indexing out of range.",NULL);
#endif
...
static int tolua_get_object_e_info(lua_State* tolua_S)
{
 ...
 tolua_index = (int)tolua_tonumber(tolua_S,2,0)-1;
#ifndef TOLUA_RELEASE
 if (tolua_index<0 || tolua_index>=max_e_idx)
 tolua_error(tolua_S,"array indexing out of range.",NULL);
#endif
